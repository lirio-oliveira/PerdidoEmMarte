...
Cenario: Realizar a comparação de 2 produtos na promoção
    ...
    Quando Posicionar o mouse em cima da miniatura do produto "Printed Summer Dress"que possui o 
    desconto de 5% ao lado do valor, e clicar no botão "+Add to compare"
